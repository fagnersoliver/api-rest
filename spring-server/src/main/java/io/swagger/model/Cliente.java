...
public class Cliente {
	...
	/**
	 * Chave primaria do cliente, identifica o cliente na consulta
	 * 
	 * @return id
	 **/
	@ApiModelProperty(value = "Chave primaria do cliente, identifica o cliente na consulta")
	 ...
	 * @return tipo
	 **/
	@ApiModelProperty(value = "Campo de cliente")
